...
public class MyPanel extends JPanel implements KeyListener,Runnable {
    ...
    public MyPanel() {
        hero = new Hero(100, 100);//设置初始位置
        hero.setSpeed(2);//设置移动速度
    ...
    public void paint(Graphics g) {
        ...
        //画出自己的坦克-封装方法
        drawTank(hero.getX(), hero.getY(), g, hero.getDirect(), 1);//自己的坦克出生位置
        //画出hero射击的子弹
        ...
        for (int i = 0; i < enemyTanks.size(); i++) {
            ...
            drawTank(enemyTank.getX(), enemyTank.getY(), g, enemyTank.getDirect(), 0);//敌人的坦克出生位置
        }
